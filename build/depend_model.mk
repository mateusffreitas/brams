...
ModMessagePassing.o  : $(MPI)/ModMessagePassing.f90 mem_grid.o \
...
mem_basic.o : $(MEMORY)/mem_basic.f90 mem_grid.o var_tables.o ModNamelistFile.o $(UTILS_INCS)/i8.h \
	mem_stilt.o
	@cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src
...
ModTuvDriver2.7.o : $(TUV)/ModTuvDriver2.7.f90 ref_sounding.o mem_rrtm.o mem_all.o extra.o tuvParameter.o rconstants.o mem_grid.o \
...
mem_globrad.o : $(RADIATE)/mem_globrad.f90 node_mod.o mem_precision.o mem_aerad.o \
...
mem_carma.o : $(RADIATE)/mem_carma.f90 ReadBcst.o grid_dims.o var_tables.o \
...
mem_scalar.o : $(MEMORY)/mem_scalar.f90 io_params.o var_tables.o ModNamelistFile.o \
	$(UTILS_INCS)/i8.h
	@cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src
...
mem_scratch1_grell.o : $(CUPARM)/mem_scratch1_grell.f90 mem_grell_param2.o ccatt_start.o
	@cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src
...
oda_sta_input.o : $(FDDA)/oda_sta_input.f90 obs_input.o mem_oda.o mem_grid.o ModDateUtils.o
	@cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src
...
cu_read.o : $(CUPARM)/cu_read.f90 isan_coms.o  mem_basic.o mem_cuparm.o mem_grid.o \
...
rams_mem_alloc.o : $(MEMORY)/rams_mem_alloc.F90 parrrsw.o mem_globaer.o  extra.o \
...
rtimh.o : $(MODEL)/rtimh.F90 radvc_mnt.o mem_basic.o mem_cuparm.o optical.o \
...
ModOneProc.o : $(MODEL)/ModOneProc.F90 ModVarfFile.o ModEvaluation.o ModNamelistFile.o \
...
nud_update.o : $(FDDA)/nud_update.f90 mem_aerad.o  an_header.o grid_struct.o \
...
leaf3_ocean_only.o : $(SURFACE)/leaf3_ocean_only.f90 cup_grell3.o ConvPar_GF_GEOS5.o  node_mod.o io_params.o  \
...
gaspart.o : $(TEB_SPM)/gaspart.f90 mem_teb_vars_const.o mem_grid.o mem_leaf.o mem_basic.o \
...
ndvi_read.o : $(MKSFC)/ndvi_read.f90 ReadBcst.o  io_params.o mem_grid.o mem_leaf.o \
	node_mod.o mem_mksfc.o ModDateUtils.o
	@cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src

mksfc_driver.o : $(MKSFC)/mksfc_driver.f90 ReadBcst.o teb_spm_start.o io_params.o \
...
mpass_full.o : $(MPI)/mpass_full.f90 mem_turb.o mem_basic.o  io_params.o mem_aerad.o \
...
nest_geosst.o : $(MKSFC)/nest_geosst.f90 ccatt_start.o  io_params.o mem_basic.o node_mod.o \
...
raco.o : $(MODEL)/raco.f90 ref_sounding.o  mem_basic.o mem_grid.o mem_scratch.o \
...
radvc_rk.o : $(MODEL)/radvc_rk.f90 mem_tend.o var_tables.o mem_stilt.o \
...
rbnd.o : $(BC)/rbnd.f90 ccatt_start.o  mem_basic.o mem_grid.o mem_scratch.o \
...
rinit.o : $(INIT)/rinit.f90 mem_varinit.o  io_params.o mem_basic.o mem_grid.o \
...
rtimi.o : $(MODEL)/rtimi.f90 shcu_vars_const.o mem_grell.o  mem_basic.o mem_grid.o mem_scratch.o \
	mem_tend.o node_mod.o var_tables.o $(UTILS_INCS)/i8.h
	@cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src

ruser.o : $(SURFACE)/ruser.f90 node_mod.o memSoilMoisture.o mem_leaf.o leaf_coms.o ccatt_start.o  io_params.o mem_grid.o rconstants.o
	@cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src

vtab_fill.o : $(MEMORY)/vtab_fill.f90 mem_aer1.o aer1_list.o io_params.o var_tables.o \
	mem_grid_dim_defs.o mem_grid.o $(UTILS_INCS)/i8.h chem1_list.o mem_chem1.o
	@cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src

extra.o : $(MEMORY)/extra.f90 ModNamelistFile.o var_tables.o
	@cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src
...
mem_aer1.o : $(CCATT)/mem_aer1.f90 mem_chem1.o io_params.o node_mod.o mem_grid.o aer1_list.o var_tables.o grid_dims.o \
	ModNamelistFile.o
	@cp -f  $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src
...
chem_sources.o  : $(CCATT)/chem_sources.f90 ReadBcst.o mem_chem1.o mem_aer1.o \
...
turb_k.o : $(TURB)/turb_k.f90 radvc_mnt.o  ke_coms.o mem_basic.o \
...
turb_diff.o : $(TURB)/turb_diff.f90 mem_cuparm.o  mem_grid.o \
...
mic_driv_new.o : $(MICRO)/mic_driv_new.f90 mem_chemic.o mem_chem1aq.o mem_chem1.o  mem_basic.o mem_grid.o \
	mem_micro.o mem_radiate.o micphys.o node_mod.o mem_micro_optij.o
	@cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src

module_rams_microphysics_2M.o : $(MICRO)/module_rams_microphysics_2M.f90 mem_scratch.o mem_leaf.o  mem_basic.o mem_grid.o mem_micro.o \
	mem_radiate.o micphys.o node_mod.o \
	mem_chemic.o mem_chem1aq.o
	@cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
...
local_proc.o : $(MODEL)/local_proc.F90 ReadBcst.o node_mod.o mem_varinit.o mem_cuparm.o grid_dims.o \
	mem_grid.o rconstants.o ref_sounding.o io_params.o mem_stilt.o
	@cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src

mic_init.o : $(MICRO)/mic_init.f90 mem_grid.o  micphys.o rconstants.o
	@cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src
...
rad_carma.o : $(RADIATE)/rad_carma.F90 mem_aer1.o ccatt_start.o aer1_list.o  mem_aerad.o mem_carma.o \
...
rtm_driver.o : $(RADIATE)/rtm_driver.f90 leaf_coms.o  grid_dims.o \
	mem_basic.o mem_grid.o mem_leaf.o mem_micro.o \
	mem_radiate.o mem_scalar.o mem_scratch.o mem_tend.o \
	micphys.o rad_carma.o rconstants.o ref_sounding.o  \
	teb_spm_start.o mem_teb_common.o \
...
rconv_grell_catt.o : $(CUPARM)/rconv_grell_catt.f90 ccatt_start.o  Phys_const.o \
...
cup_grell3.o : $(CUPARM)/cup_grell3.F90 ModPostUtils.o ccatt_start.o  Phys_const.o mem_jules.o \
	extra.o io_params.o mem_basic.o mem_cuparm.o mem_grell.o \
	mem_grell_param2.o mem_grid.o mem_leaf.o mem_micro.o \
	mem_scalar.o mem_scratch.o mem_scratch1_grell.o mem_tconv.o \
...
cup_grell_catt_shallow.o : $(CUPARM)/cup_grell_catt_shallow.f90 mem_varinit.o  \
	Phys_const.o cup_output_vars.o mem_grell_param2.o \
...
inithis.o : $(IO)/inithis.f90 mem_varinit.o mem_chem1.o chem1_list.o  an_header.o io_params.o leaf_coms.o \
...
recycle.o : $(IO)/recycle.f90 ReadBcst.o mem_chem1.o mem_aer1.o chem1_list.o aer1_list.o  io_params.o mem_grid.o mem_leaf.o \
...
asgen.o : $(ISAN)/asgen.f90 mem_grid.o isan_coms.o io_params.o ModDateUtils.o
	@cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src

asti2.o : $(ISAN)/asti2.f90 rconstants.o isan_coms.o ModDateUtils.o
	@cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src
...
v_interps.o : $(ISAN)/v_interps.f90 rconstants.o isan_coms.o
	@cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src

chem_isan_coms.o : $(ISAN_CHEM)/chem_isan_coms.f90 isan_coms.o aer1_list.o chem1_list.o
	@cp -f  $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src
...
chem_asgen.o : $(ISAN_CHEM)/chem_asgen.F90 node_mod.o mem_grid.o mem_aer1.o chem1_list.o mem_chem1.o chem_isan_coms.o io_params.o
	@cp -f  $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src

chem_asti2.o : $(ISAN_CHEM)/chem_asti2.f90 rconstants.o chem_isan_coms.o
	@cp -f  $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src

chem_asti.o : $(ISAN_CHEM)/chem_asti.f90 mem_chem1.o mem_aer1.o chem_isan_coms.o mem_grid.o rconstants.o
	@cp -f  $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src

chem_astp.o : $(ISAN_CHEM)/chem_astp.F90 mem_varinit.o chem1_list.o mem_chem1.o chem_isan_coms.o rconstants.o
	@cp -f  $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src

chem_avarf.o : $(ISAN_CHEM)/chem_avarf.f90 mem_chem1.o mem_aer1.o chem_isan_coms.o mem_grid.o rconstants.o
	@cp -f  $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src

chem_file_inv.o : $(ISAN_CHEM)/chem_file_inv.f90 mem_grid.o chem_isan_coms.o
	@cp -f  $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src
...
chem_fastjx_driv.o : $(CCATT)/chem_fastjx_driv.f90 rconstants.o chem_fastjx_data.o chem1_list.o carma_fastjx.o \
...
chem_spack_ros_dyndt.o : $(CCATT)/chem_spack_ros_dyndt.f90 chem_spack_ros.o chem_spack_kinetic.o chem_spack_jacdchemdc.o chem_spack_fexchem.o chem_spack_lu.o mem_scalar.o mem_grid.o mem_all.o\
        mem_basic.o mem_micro.o mem_radiate.o chem1_list.o mem_chem1.o aer1_list.o mem_aer1.o \
...
chem_spack_rodas3_dyndt.o : $(CCATT)/chem_spack_rodas3_dyndt.f90 chem_spack_ros.o chem_spack_kinetic.o chem_spack_jacdchemdc.o chem_spack_fexchem.o extra.o  chem_spack_lu.o mem_scalar.o mem_grid.o mem_all.o\
        mem_basic.o mem_micro.o mem_radiate.o chem1_list.o mem_chem1.o aer1_list.o mem_aer1.o \
	chem_spack_solve_sparse.o mem_spack.o  chem_fastjx_driv.o chem_uv_att.o
	@cp -f  $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
...
chem_spack_qssa.o : $(CCATT)/chem_spack_qssa.f90 chem_spack_rates.o chem_spack_kinetic.o chem_spack_dratedc.o mem_scalar.o mem_grid.o mem_all.o mem_basic.o\
...
ModPostOneFieldUtils.o : $(POST_SRC)/ModPostOneFieldUtils.f90 \
    ModOutputUtils.o ModBramsGrid.o ModPostGrid.o
	@cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src
...
ModPostUtils.o : $(POST_SRC)/ModPostUtils.f90 mem_leaf.o ModNamelistFile.o \
...
modTimeLineFRN.o : $(POST_SRC)/modTimeLineFRN.f90 ReadBcst.o meteogram.o ModPostTypes.o
	@cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src

rexev.o : $(STILT)/rexev.f90 mem_scratch.o   mem_tend.o  mem_basic.o\
	mem_grid.o mem_stilt.o
	@cp -f  $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src

rstilt.o : $(STILT)/rstilt.f90 radvc_mnt.o mem_turb.o mem_scratch1_grell.o mem_cuparm.o   mem_basic.o\
...
radvc_mnt.o : $(MODEL)/radvc_mnt.f90 chem_dry_dep.o mem_chem1.o mem_aer1.o ccatt_start.o  mem_basic.o mem_grid.o mem_scratch.o \
...
seasalt.o: $(CCATT)/seasalt.f90 mem_aer1.o ccatt_start.o aer1_list.o mem_leaf.o mem_grid.o leaf_coms.o \
...
meteogram.o: $(IO)/meteogram.f90 ModPostUtils.o node_mod.o meteogramType.o mem_grid.o var_tables.o satPolyColision.o node_mod.o
	@cp -f  $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src
...
isorev.o: $(MATRIX)/isorev.f90 issoropia.o isrpia.o
	cp -f  $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)
...
mic_thompson_driver.o : $(MICRO)/mic_thompson_driver.f90 mem_leaf.o  mem_basic.o mem_grid.o mem_micro.o \
...
mic_wsm_driver.o : $(MICRO)/mic_wsm_driver.f90 mem_leaf.o  mem_basic.o mem_grid.o mem_micro.o \
	mem_radiate.o micphys.o node_mod.o rconstants.o  io_params.o mem_radiate.o\
...
module_mp_thompson.o : $(MICRO)/module_mp_thompson.f90 node_mod.o  module_mp_radar.o
	@cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src

mic_gfdl_driver.o : $(MICRO)/mic_gfdl_driver.f90 mem_leaf.o  mem_basic.o mem_grid.o mem_micro.o \
	mem_radiate.o micphys.o node_mod.o rconstants.o  io_params.o mem_radiate.o\
...
gfdl_cloud_microphys.o : $(MICRO)/gfdl_cloud_microphys.F90 node_mod.o module_mp_radar.o
	@cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src
...
optical.o : $(RADIATE)/optical.f90 ccatt_start.o mem_grid.o var_tables.o node_mod.o parlibf.o \
	ReadBcst.o aer1_list.o mem_aer1.o mem_leaf.o
	@cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src

dam.o : $(ENERGY)/dam.f90 ModNamelistFile.o mem_grid.o dump.o
	@cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src

mod_aer.o : $(AERCLIM)/mod_aer.f90 ReadBcst.o node_mod.o mem_grid.o mem_basic.o dump.o
	@cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src

initMicThompson.o : $(MICRO)/initMicThompson.f90 ReadBcst.o ReadBcst.o mem_micro.o mem_basic.o node_mod.o
	@cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src
...
modIau.o : $(MODEL)/modIau.f90 ReadBcst.o node_mod.o ModNamelistFile.o mem_varinit.o mem_tend.o mem_grid.o dump.o
	@cp -f $< $(<F:.F90=.F90)
	$(F_COMMAND) $(<F:.F90=.F90) $(EXTRAFLAGSF)
	@mv -f $(<F:.f90=.f90) ../doc/src
